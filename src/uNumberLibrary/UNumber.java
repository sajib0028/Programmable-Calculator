...
UNumber implements Comparable<UNumber> {
	 ...
	 * 
	 * @param that UNumber variable that
	 * @param size int variable size
	 */
	 ...
	 */public UNumber(double v){
		 ...
		 * @return Calculate and return result
		 */
	 ...
	 * @return calculate and return the result
	 */
...
/**
 * Square Root function developed by Newton Rapson Method
 * @return temp1 as a value of sqrt
 */
	public UNumber sqrt() {
		...
		temp1= new UNumber(2);
		UNumber two = new UNumber(2);  //divided the value by 2
		
		int i;
		for(i=0;i<=25;i++) {    //used 25 iteration
			if (i!=0) {
			}
			temp.div(temp1);
			temp1.add(temp);
			temp1.div(two);
			temp = new UNumber (this);
			//System.out.println( "Value of Iteration " + a + " : " + temp1.toDecimalString());
			
		}
		//System.out.println("The Square Root ="+ temp1.toDecimalString());
