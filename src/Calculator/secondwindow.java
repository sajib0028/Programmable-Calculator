...
public class secondwindow extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        fsmValue.setTextFill(Color.web("red"));
        fsmError.setTextFill(Color.web("red"));
        ...
        valueTextField.textProperty().addListener((observable, oldvalue, newValue) -> {
        	addButton.setDisable(false);
            System.out.println(CalculatorValue.checkMeasureValue(valueTextField.getText()));
            fsmValue.setText(CalculatorValue.checkMeasureValue(valueTextField.getText()));
            if (!fsmValue.getText().isEmpty()) {
            	addButton.setDisable(true);
            }
            message.setText("");
        });
        ...
        errorTextField.textProperty().addListener((observable, oldvalue, newValue) -> {
            ...
            System.out.println(BusinessLogic.checkErrorTerm(errorTextField.getText()));
            fsmError.setText(BusinessLogic.checkErrorTerm(errorTextField.getText()));
            if (!fsmError.getText().isEmpty()) {
             	addButton.setDisable(true);
             }
    ...
    private boolean doNameExists(String name) {
        ...
        ArrayList<Entries> entries = Tableview.readRepo();
        int i = 0;
